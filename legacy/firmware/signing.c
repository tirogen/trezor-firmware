...
static bool is_coinjoin;  // Is this a CoinJoin transaction?
...
static bool signing_add_output(TxOutputType *txoutput) {
  ...
  bool skip_confirm = is_change || is_replacement || is_coinjoin;
...
bool signing_is_preauthorized(void) { return signing && is_coinjoin; }
