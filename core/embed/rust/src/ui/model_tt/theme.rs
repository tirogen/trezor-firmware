...
// UI icons (greyscale).
pub const ICON_CANCEL: NamedToif =
    NamedToif::new(include_res!("model_tt/res/cancel.toif"), "cancel");
pub const ICON_CONFIRM: NamedToif =
    NamedToif::new(include_res!("model_tt/res/confirm.toif"), "confirm");
pub const ICON_SPACE: NamedToif = NamedToif::new(include_res!("model_tt/res/space.toif"), "space");
pub const ICON_BACK: NamedToif = NamedToif::new(include_res!("model_tt/res/back.toif"), "back");
pub const ICON_CLICK: NamedToif = NamedToif::new(include_res!("model_tt/res/click.toif"), "click");
pub const ICON_NEXT: NamedToif = NamedToif::new(include_res!("model_tt/res/next.toif"), "next");
pub const ICON_WARN: NamedToif =
    NamedToif::new(include_res!("model_tt/res/warn-icon.toif"), "warn");
pub const ICON_MAGIC: NamedToif = NamedToif::new(include_res!("model_tt/res/magic.toif"), "magic");
pub const ICON_LIST_CURRENT: NamedToif =
    NamedToif::new(include_res!("model_tt/res/current.toif"), "current");
pub const ICON_LIST_CHECK: NamedToif =
    NamedToif::new(include_res!("model_tt/res/check.toif"), "check");
pub const ICON_LOCK: NamedToif = NamedToif::new(include_res!("model_tt/res/lock.toif"), "lock");
...
pub const IMAGE_FG_WARN: NamedToif =
    NamedToif::new(include_res!("model_tt/res/warn_fg.toif"), "warn_fg");
pub const IMAGE_FG_SUCCESS: NamedToif =
    NamedToif::new(include_res!("model_tt/res/success_fg.toif"), "success_fg");
pub const IMAGE_FG_ERROR: NamedToif =
    NamedToif::new(include_res!("model_tt/res/error_fg.toif"), "error_fg");
pub const IMAGE_FG_INFO: NamedToif =
    NamedToif::new(include_res!("model_tt/res/info_fg.toif"), "info_fg");
pub const IMAGE_BG_CIRCLE: NamedToif =
    NamedToif::new(include_res!("model_tt/res/circle.toif"), "circle");
pub const IMAGE_BG_TRIANGLE: NamedToif =
    NamedToif::new(include_res!("model_tt/res/triangle.toif"), "triangle");
pub const IMAGE_BG_BACK_BTN: NamedToif =
    NamedToif::new(include_res!("model_tt/res/back_btn.toif"), "back_btn");
pub const IMAGE_BG_BACK_BTN_TALL: NamedToif = NamedToif::new(
    include_res!("model_tt/res/back_btn_tall.toif"),
    "back_btn_tall",
);

// Scrollbar/PIN dots.
pub const DOT_ACTIVE: NamedToif = NamedToif::new(
    include_res!("model_tt/res/scroll-active.toif"),
    "scroll-active",
);
pub const DOT_INACTIVE: NamedToif = NamedToif::new(
    include_res!("model_tt/res/scroll-inactive.toif"),
    "scroll-inactive",
);
pub const DOT_INACTIVE_HALF: NamedToif = NamedToif::new(
    include_res!("model_tt/res/scroll-inactive-half.toif"),
    "scroll-inactive-half",
);
pub const DOT_INACTIVE_QUARTER: NamedToif = NamedToif::new(
    include_res!("model_tt/res/scroll-inactive-quarter.toif"),
    "scroll-inactive-quarter",
);
pub const DOT_SMALL: NamedToif = NamedToif::new(
